  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <nav
          className={`lg:mx-20 flex items-center justify-between transition-all duration-300 ${isScrolled ? "px-2 py-0 backdrop-blur-2xl bg-white/60 shadow-md my-0.5 rounded-xl" : "py-4"}`}
        >
